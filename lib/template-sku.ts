...
/**
 * Interface untuk parameter surat SKU
 */
export interface SuratSKUParams {
    kodeGudep: string
    nomorSurat: string
    namaPeserta: string
    tempatLahir: string
...
/**
 * Generate HTML template untuk surat keterangan lulus SKU
 */
export const generateSuratSKUHTML = (params: SuratSKUParams): string => {
    const {
        kodeGudep,
        nomorSurat,
        namaPeserta,
